...
Broad emerging markets had a strong session Monday (EEM +2.16%, EM Asia +2.18%) but the Nifty fell 0.70% to 23,382.60, a fourth straight losing session, hence India was the odd one out. Five things to know going into Tuesday:
...
- May GST collection at ₹1.94 lakh cr was up only 3.2% YoY, but domestic GST fell 2.6% YoY anyway (import GST +19.1% masked the deceleration in the headline)

- Friday June 5 remains the week's defining session, with the RBI MPC decision, Q4 GDP, Governor's presser and US NFP all landing between 10 AM and 6 PM IST

...
| "The headline doesn't tell you what happened" / "The numbers lie" / "What most people miss" | Meta-framing — tells the reader what the post is about instead of just saying it. Added 2026-06-04 (slop pattern caught in v1 of Tweet 2). |
| "Looks like X. It wasn't." / "Sounds like Y. It's not." | Performative reveal — same family as "It isn't." Added 2026-06-04. |
| "Specific corporate news" / "key catalysts" / "important data" without naming them | Vague reference is slop. Either name the news/catalyst/data, or drop the line. Added 2026-06-04. |
| Soft-number adjectives without the exact figure ("almost 2 percent", "added a little", "ran higher", "got deeper") | Substitute with the actual number. "1.7 percent", "added 0.3 percent", "from 2.3 lakh to 2.59 lakh contracts". Added 2026-06-04. |

### Rule 7 — Direct opening (no meta-framing) — NEW 2026-06-04

The first sentence of every post is the substance, not a meta-observation about the substance.

**Banned opening patterns** (verifier C8g grep):
- "The headline doesn't tell you what happened"
- "Most people missed this"
- "Here's what's interesting"
- "Let me explain"
- "Looks like X. It wasn't."
- "The numbers lie"
- "What you saw isn't the whole story"

**Why:** These openings tell the reader what the post is about *before* saying it. They are throat-clearing. They signal the writer is about to perform a reveal. A wise market veteran does not perform reveals — he opens with the observation itself and lets the reader feel the surprise.

**Correct pattern: open with the observed fact, the surprise becomes inherent.**

| Wrong (meta) | Right (direct) |
|---|---|
| "The headline doesn't tell you what happened. The Nifty fell only a third of a percent. That looks like a flat day. It wasn't." | "Even after the IT services sector fell 5.5 percent, the Nifty closed only a third of a percent lower." |
| "What most investors missed today: the rotation." | "Banks rose 1.7 percent on the same day IT fell 5.5 percent." |
| "Looks like a recovery. Look closer." | "The Nifty rose half a percent. Sixty-seven stocks gained 3 percent or more. Almost all the gains were in IT." |

**Why it works:** The wrong version makes the writer the hero of the observation. The right version lets the data itself be the surprise. Buffett never tells the reader "what most people miss" — he just shows them.

### Rule 8 — Specific numbers, never adjectives — NEW 2026-06-04

Every numeric claim takes the exact number, not a paraphrase or rounding.

**Banned vague-numeric language** (verifier C8h WARN):

| Wrong (vague) | Right (specific) |
|---|---|
| "almost 2 percent" | "1.7 percent" |
| "around 2 lakh" | "2.59 lakh" |
| "got deeper" | "from 2.3 lakh to 2.59 lakh contracts" |
| "added a little" | "0.3 percent" |
| "kept selling cash" | "sold 5,617 crore rupees" |
| "ran higher" | "rose 6.4 percent" |
| "rose" (without number when the number is in the brief) | "rose 6 percent to 16.3" |
| "fell sharply" | "fell 8.4 percent" |
| "significant move" | "[N] percent move" |

**Why:** Vague numbers are slop. They signal that the writer either doesn't know the number, didn't bother to look it up, or thinks the reader can't handle precision. None of those is the wise-veteran voice. The brief always has the number. The podcast script always has the number. The X post must have it too. Compression in Twitter means **fewer words around the number, not fewer numbers**.

**Exception:** Approximations are acceptable when the precision is irrelevant to the point AND the approximation is signposted:
- "about a lakh puts and a lakh calls" — when both are ~1.05L and ~1.08L, the round-down preserves the protective-hedge logic without falsely-precise numerology.
- Round-figures for thresholds: "Sixty-seven stocks gained 3 percent or more" — when the threshold IS 3% and the count is the data.

**Test:** If you remove the adjective ("almost", "around", "roughly", "a little") and the replacement number is in the brief, USE THE NUMBER.

### The 5-question self-check before submitting any X 3-post draft (expanded 2026-06-04)
...
3. **Does each post OPEN with the substance, not a meta-observation about the substance?** (No "the headline doesn't tell you", no "looks like X. It wasn't", no "what most people miss".)
4. **Does every numeric claim have the exact number from the brief?** (No "almost 2 percent" when the number is 1.7. No "got deeper" without "from 2.3 lakh to 2.59 lakh".)
5. **Would a 30-year fund manager read this aloud at a family dinner without sounding wrong?**

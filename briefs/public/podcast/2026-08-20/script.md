...
**Revision:** **v3 — two micro-fixes on the re-verify's WARN.** v2 was the one permitted fix pass against the cold read's FAIL. Backups: `backups/2026-08-21/podcast-script_2026-08-20_v1.md` and `_v2.md`.
**Cold-read verifier (`verify-podcast-script-nse`):** v1 **FAIL** — L1 16 / L2 1 / L3 1 / L4 2 / L5 0 / L6 0, S1 2. v2 re-verified **WARN** — L1 2, L2/L3/L4/S1 all zero, guard scan clean, all six blockers judged genuinely fixed; verifier recommendation "ship it". All three of the pass's overrides (the oil mechanism, the Indo Borax beat drop, the "Good evening" declaration) were upheld on re-read. Report at `verify-report.md`.

## v3 — the two micro-fixes on the WARN

**W1, a regression the fix pass introduced, now repaired.** Cutting "Asia rallied and India rallied least" to pay down the ceiling removed the comparison the next sentence depends on: "The likely reason India lagged" had nothing stated to lag against, leaving the listener to infer it from arithmetic across four numbers, in audio, with no way to re-read. It also dropped the skill's Section 3 divergence spec. **Restored verbatim as its own short sentence.**

**W2, the breadth hedge, restored.** The ratio was fully unhedged where the brief hedges it twice. Now "About three and a half shares rose for every one that fell, **on one live count**."

**How both were paid for, since the script was already at the 700 ceiling.** Ten words came out, and **not one of them from a connective sentence, a gloss, a guard or the sugar causal chain** — the verifier's own diagnosis was that all three regressions came from deleting short connective lines, which are cheap per line and load-bearing per minute. Instead the words came out of the interiors of long sentences: "each rose a little over one percent" to "a little over one percent each"; "one hundredth" to "a hundredth"; "reported as a sixteen year high" to "a reported sixteen year high"; "and that is what lifted the shares" to "and that lifted the shares"; "and both were arguing" to "both arguing"; "India's rate itself" to "India's rate"; "The Reserve Bank of India next meets" to "The Reserve Bank next meets" (the full name is established four sentences earlier); and "and sugar shares rose up to eighteen percent" to "with sugar shares up to eighteen percent". Every figure, hedge, gloss and causal link is byte-identical to the WARN-verified v2.

**Standing decision referred to the principal (W5), not patched.** "India buys almost all of its oil from abroad" is correct, and the verifier confirmed it is the clause that makes the episode's causal chain close — but it is universally-known context that the brief itself does not carry, while this header claims brief-only sourcing. Whether the audio may add such context is a policy call, not a defect. **The sentence is left in**, and this header now flags the tension rather than hiding it.
...
Here is where the market closed. The Nifty fifty finished at twenty four thousand two hundred and thirty one, up zero point six four percent. About three and a half shares rose for every one that fell, on one live count.

Asia rallied, and India rallied least. Korea's Kospi gained roughly five and a half to six percent, and Japan and Hong Kong a little over one percent each. The likely reason India lagged is oil. Brent crude rose for a fifth straight session, to ninety three dollars and eighty seven cents a barrel. India buys almost all of its oil from abroad, so a dearer barrel feeds straight into Indian inflation, and inflation is what the Reserve Bank is already worried about. The Strait of Hormuz, which carries much of the world's oil, has been shut since February. The rally came from Washington. The brake came from Hormuz.

On Wednesday the American Treasury said it will at least double its buybacks of long dated government bonds, from two billion dollars an operation to at least four billion. A bond's yield is what it pays whoever holds it. Long term American yields fell the same session, the ten year by five point seven basis points, to about four point six five percent. A basis point is a hundredth of one percent.
...
The biggest gain was a sugar producer, Balrampur Chini Mills, up seventeen point eight seven percent, with sugar shares up to eighteen percent industry wide. On Wednesday the government capped bulk buyers of sugar at fifteen days of stock. The order binds buyers, not mills, and it is meant to bring sugar prices down, not push them up. But a government only rations stock when the price has already run hard. Spot sugar touched five thousand five hundred and thirty rupees for a hundred kilos, a reported sixteen year high. Which is good for the mills that sell it, and that lifted the shares.
